air_blocks = ["minecraft:air","minecraft:water","minecraft:brown_mushroom","minecraft:snow", "minecraft:spruce_leaves","minecraft:glass","minecraft:fern","minecraft:large_fern",
              "minecraft:grass","minecraft:pointed_dripstone","minecraft:dead_bush","minecraft:peony","minecraft:crimson_fence","minecraft:oxidized_cut_copper_stairs","byg:pink_anemone",

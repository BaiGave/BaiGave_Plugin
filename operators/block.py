...
def block(textures,elements,display,position,filename,has_air):
    ...
    vertices,faces,direction,texture_list,uv_list,uv_rotation_list = extract_vertices_from_elements(textures, elements, display, has_air, None, vertices, faces, direction, texture_list, uv_list, uv_rotation_list, vertices_dict)
